function CapturePreviewPage({ onNavigate, capturedUrl }) {
  return (
    <section className="phone camera-screen">
      <div className="camera-view">
        <div className="camera-top">
          <button className="back-button dark-button" onClick={() => onNavigate('camera')}>← 재촬영</button>
          <span>촬영 완료</span>
        </div>
      ...
      <div className="preview-actions">
        <button className="action" onClick={() => onNavigate('camera')}>다시 촬영</button>
